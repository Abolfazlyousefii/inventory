...
class RoleSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $roles = [
            ...
            'warehouse_manager' => ['dashboard.view','products.view','products.show','warehouse.collection.queue.view','warehouse.collection.view','warehouse.collection.receive','warehouse.collection.start','warehouse.collection.edit','warehouse.collection.submit_reapproval','warehouse.collection.adjust_price','warehouse.shipping.queue.view','warehouse.shipping.view','warehouse.shipping.ship','warehouse_reservations.view','inventory.view','inventory.adjust','inventory.count.view','warehouse_map.view','transfers.view','sales_returns.view'],
