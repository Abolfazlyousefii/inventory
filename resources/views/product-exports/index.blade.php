...
.output-mode-box{border:1px solid var(--border);background:#F8FBFC;padding:.55rem .65rem}.output-mode-title{font-size:.75rem;font-weight:700;margin-bottom:.35rem}.output-mode-options{display:flex;gap:.5rem;flex-wrap:wrap}.output-mode-option{flex:1 1 220px;display:flex;gap:.45rem;align-items:flex-start;border:1px solid #D9E5EB;background:#fff;padding:.5rem .6rem;cursor:pointer}.output-mode-option:has(input:checked){border-color:#75AFCB;background:#EEF7FA}.output-mode-option strong{display:block;font-size:12px}.output-mode-option small{display:block;color:var(--muted);font-size:10.5px;margin-top:.1rem}.visit-price-list{padding:.75rem}.visit-product-card{border:1px solid #C9D7DF;margin-bottom:.7rem;background:#fff}.visit-product-header{display:grid;grid-template-columns:minmax(0,1fr) auto;align-items:stretch;background:#EDF5F8;border-top:1.2px solid #173A53}.visit-product-main{display:flex;align-items:center;gap:.55rem;padding:.45rem .65rem}.visit-product-image{width:38px;height:38px;object-fit:contain}.visit-product-info h3{font-size:13px;margin:0;color:#183747}.visit-product-info p{font-size:10px;margin:.15rem 0 0;color:#71828D}.visit-product-price-summary{display:flex;align-items:center;justify-content:center;padding:.45rem .7rem;border-right:1px solid #D7E2E8;color:var(--blue);font-size:12px;white-space:nowrap}.visit-table-head,.visit-table-row{display:grid;grid-template-columns:5% 29% 17% 17% 10% 22%}.visit-table-head{background:#173A53;color:#fff;font-size:11px;font-weight:700;text-align:center}.visit-table-head span,.visit-table-row>div{padding:.4rem .45rem;border-left:1px solid #D7E2E8}.visit-table-head span:last-child,.visit-table-row>div:last-child{border-left:0}.visit-table-row{font-size:11.5px;border-bottom:1px solid #E4EBEF}.visit-table-row:nth-child(even){background:#FAFCFD}.visit-table-row>div{display:flex;align-items:center;justify-content:center;min-width:0}.visit-table-row .visit-model{justify-content:flex-start;text-align:right}.visit-code{direction:ltr;unicode-bidi:isolate}.visit-stock,.visit-price{font-weight:700;white-space:nowrap}.visit-stock--zero{color:#6B7280}@media(max-width:700px){.output-mode-options{display:block}.output-mode-option{margin-bottom:.4rem}.visit-product-header{display:block}.visit-product-price-summary{border-right:0;border-top:1px solid #D7E2E8}.visit-table-head{display:none}.visit-table-row{display:block;padding:.25rem .5rem}.visit-table-row>div{display:grid;grid-template-columns:100px minmax(0,1fr);justify-content:initial;text-align:right;border:0;padding:.25rem 0}.visit-table-row>div:before{content:attr(data-label);font-weight:700;color:var(--muted)}.visit-table-row .visit-model{display:grid}}

</style>
<main class="product-export-page" data-children-url-template="{{ route('admin.product-exports.categories.children', ['category' => '__ID__']) }}" data-model-lists-url="{{ route('admin.product-exports.model-lists') }}" data-products-search-url="{{ route('admin.product-exports.products.search') }}" data-data-url="{{ route('admin.product-exports.data') }}" data-print-url="{{ route('admin.product-exports.print') }}" data-selected-models='@json($selectedModels)'>
<header class="catalog-hero"><h1>لیست قیمت محصولات آریا گستر</h1><p>فیلترها را انتخاب کنید، پیش‌نمایش را ببینید و فهرست را چاپ یا به‌صورت PDF ذخیره کنید.</p></header>
...
<div class="w-100"></div>
<div class="col-12"><div class="output-mode-box"><div class="output-mode-title">نوع خروجی</div><div class="output-mode-options"><label class="output-mode-option"><input class="form-check-input" type="radio" name="output_mode" value="visit" @checked(($filters['output_mode'] ?? 'visit') === 'visit')><span><strong>لیست ویزیتوری</strong><small>هر تنوع در یک ردیف با قیمت، موجودی، رنگ و کد دقیق</small></span></label><label class="output-mode-option"><input class="form-check-input" type="radio" name="output_mode" value="catalog" @checked(($filters['output_mode'] ?? 'visit') === 'catalog')><span><strong>کاتالوگ محصولات</strong><small>گروه‌بندی مدل‌ها و رنگ‌ها با ظاهر فعلی</small></span></label></div></div></div>
<div class="w-100"></div>
