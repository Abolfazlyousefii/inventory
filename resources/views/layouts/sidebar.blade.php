@php
    ...
    $salesActive = $isSalesReturnRoute || $isRoute('sales-returns.*', 'preinvoice.create', 'preinvoice.my.*', 'customers.*', 'persons.*', 'commercial.invoice-reassignments.*');
...
<aside class="app-sidebar"
    ...
    <div class="sidebar-scroll">
            ...
            <div class="sidebar-accordion-item {{ $warehouseActive ? 'is-open' : '' }}" data-accordion-section="warehouse">
                ...
                <div class="sidebar-accordion-panel" data-accordion-panel>
                    <div class="sidebar-submenu">
                        ...
                        @endcanPermission
                        @canPermission('page.warehouse.inbound_queue')
                            <a class="sidebar-sublink {{ $is('warehouse.inbound.*') ?: $pathActive('warehouse/inbound-queue', 'warehouse/inbound-queue/*') }}" href="{{ route('warehouse.inbound.index') }}">صف ورودی موجودی</a>
                        @endcanPermission
        ...
        @canAnyPermission(['preinvoices.create','preinvoices.own.view','customers.view','page.sales.returns','page.commercial.invoice_reassignments'])
