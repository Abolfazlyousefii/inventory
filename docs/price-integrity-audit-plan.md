...
- ردیف‌های گزارش با semantics جایگزینی امن ساخته می‌شوند تا مقادیر واقعی مانند نام محصول/تنوع، موجودی انبار، قیمت فروش صفر واقعی، سابقه فروش مثبت و `updated_at` اسناد روی مقدارهای خالی پیش‌فرض حفظ شوند.
