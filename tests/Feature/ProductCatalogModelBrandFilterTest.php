...
{ use RefreshDatabase;
    ...
    public function test_one_model_checkbox_filters_products(): void { $this->signIn(); [$a,$b]=$this->models('Samsung'); $p=$this->product('One model'); $this->variant($p,$a,'A15 only'); $this->variant($p,$b,'A25 hidden'); $this->get(route('admin.product-exports.data',['model_brand'=>'Samsung','model_list_ids'=>[$a->id]]))->assertOk()->assertSee('A15 only')->assertDontSee('A25 hidden'); }
