...
// Normal delivery is synchronous immediately after source commit. This
// scheduler is only the durable recovery path for a process crash or a
// transient post-commit calculation failure.
Schedule::call(function () {
