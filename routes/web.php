...
Route::get('/vouchers/sales/{uuid}/view', [InvoiceController::class, 'salesVoucherShow'])->middleware('role:admin|Admin|warehouse|Warehouse|manager|Manager|finance|Accountant')->name('vouchers.sales.show');
