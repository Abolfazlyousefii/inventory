...
class CommissionSourceObserver
{
    ...
    private function stage(Model $model): void
    {
        ...
        // An item may theoretically move between invoices. Reconcile both the
        // old and new owners when applicable.
        ...
        foreach ($invoiceIds as $invoiceId) {
            ...
            if (! $invoice) {
                // Parent Invoice deletion has its own observer callback and its
                // immutable invoice-number snapshot is the canonical cleanup path.
                continue;
            }
