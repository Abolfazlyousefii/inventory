...
class PageAccessCatalog
{
    ...
    private const ROUTE_OWNERS = [
        ...
        'finance.seller-sales.destroy' => ['finance.seller_sales_documents'],
        'finance.seller-sales.print' => ['finance.seller_sales_documents'],
        'finance.seller-sales.adjustments.store' => ['finance.seller_sales_documents'],
        'finance.seller-sales.adjustments.destroy' => ['finance.seller_sales_documents'],
        'finance.seller-sales.bonus' => ['finance.seller_sales_documents'],
        'finance.seller-sales.confirm' => ['finance.seller_sales_documents'],
        'finance.seller-sales.finalize' => ['finance.seller_sales_documents'],
        'finance.seller-sales.recalculate' => ['finance.seller_sales_documents'],
        'finance.commission-rates.index' => ['finance.seller_sales_documents'],
        'finance.commission-rates.tree' => ['finance.seller_sales_documents'],
        'finance.commission-rates.rates.store' => ['finance.seller_sales_documents'],
        'finance.commission-rates.rates.destroy' => ['finance.seller_sales_documents'],
        'finance.commission-rates.rates.history' => ['finance.seller_sales_documents'],
        'finance.org-commission.index' => ['finance.seller_sales_documents'],
        'finance.org-commission.departments.store' => ['finance.seller_sales_documents'],
        'finance.org-commission.departments.update' => ['finance.seller_sales_documents'],
        'finance.org-commission.departments.toggle' => ['finance.seller_sales_documents'],
        'finance.org-commission.departments.members.sync' => ['finance.seller_sales_documents'],
        'finance.org-commission.create' => ['finance.seller_sales_documents'],
        'finance.org-commission.store' => ['finance.seller_sales_documents'],
        'finance.org-commission.seller-total' => ['finance.seller_sales_documents'],
        'finance.org-commission.show' => ['finance.seller_sales_documents'],
        'finance.org-commission.edit' => ['finance.seller_sales_documents'],
        'finance.org-commission.update' => ['finance.seller_sales_documents'],
        'finance.org-commission.destroy' => ['finance.seller_sales_documents'],
        'finance.org-commission.confirm' => ['finance.seller_sales_documents'],
        'finance.org-commission.finalize' => ['finance.seller_sales_documents'],
        'finance.org-commission.print' => ['finance.seller_sales_documents'],
