...
class PageAccessCatalog
{
    ...
    private const ROUTE_OWNERS = [
        ...
        'finance.seller-sales.report-invoices' => ['finance.seller_sales_documents'],
        'finance.seller-sales.manual-invoice' => ['finance.seller_sales_documents'],
        'finance.seller-sales.preview' => ['finance.seller_sales_documents'],
