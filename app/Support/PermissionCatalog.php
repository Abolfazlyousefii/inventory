...
class PermissionCatalog
{
    ...
    public static function groups(): array
    {
        return [
            ...
            'پیش‌فاکتور و فروش' => [
                ...
                'sales_returns.create' => 'ایجاد پیش‌نویس برگشت از فروش',
                'sales_returns.edit_draft' => 'ویرایش پیش‌نویس برگشت از فروش',
                'sales_returns.cancel_draft' => 'لغو پیش‌نویس برگشت از فروش',
                'sales_returns.apply' => 'اعمال نهایی برگشت از فروش',
                'sales_returns.print' => 'چاپ برگشت از فروش',
                'sales_returns.export' => 'خروجی برگشت از فروش',
                'sales_returns.override_destination' => 'تغییر مقصد پیش‌فرض برگشت از فروش',
                'sales_returns.create_product' => 'تعریف کالای جدید در برگشت سازه‌حساب',
                'sales_returns.override_invoice_status' => 'برگشت از فاکتور با وضعیت غیرمعمول',
            ],
            'فاکتورها و مالی' => [
    ...
    public static function routePermissions(): array
    {
        return [
            ...
            'sales-returns.index' => 'sales_returns.view', 'sales-returns.show' => 'sales_returns.view', 'sales-returns.print' => 'sales_returns.print', 'sales-returns.pdf' => 'sales_returns.print', 'sales-returns.export.excel' => 'sales_returns.export', 'sales-returns.export.pdf' => 'sales_returns.export', 'sales-returns.create' => 'sales_returns.create', 'sales-returns.store' => 'sales_returns.create', 'sales-returns.customers.search' => 'sales_returns.create', 'sales-returns.customers.invoices' => 'sales_returns.create', 'sales-returns.invoices.items' => 'sales_returns.create', 'sales-returns.products.search' => 'sales_returns.create', 'sales-returns.products.variants' => 'sales_returns.create', 'sales-returns.preview' => 'sales_returns.create', 'sales-returns.edit' => 'sales_returns.edit_draft', 'sales-returns.update' => 'sales_returns.edit_draft', 'sales-returns.cancel' => 'sales_returns.cancel_draft',
