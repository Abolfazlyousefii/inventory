...
class PermissionCatalog
{
    ...
    public static function routePermissions(): array
    {
        return [
            ...
            'products.index' => 'products.view', 'products.create' => 'products.create', 'products.store' => 'products.create', 'products.edit' => 'products.edit', 'products.update' => 'products.edit', 'products.destroy' => 'products.delete', 'products.warehouse-stock' => 'inventory.view', 'products.image' => 'products.view', 'products.sales-ledger' => 'products.ledger', 'products.purchase-ledger' => 'products.ledger', 'products.pricelist' => 'products.print', 'products.sync.crm' => 'products.import', 'products.price-changes.index' => 'products.price_changes.view', 'products.price-changes.create' => 'products.price_changes.create', 'products.price-changes.products.search' => 'products.price_changes.view', 'products.price-changes.variants.search' => 'products.price_changes.view', 'products.price-changes.categories.tree' => 'products.price_changes.view', 'products.price-changes.preview' => 'products.price_changes.create', 'products.price-changes.store' => 'products.price_changes.create', 'products.price-changes.show' => 'products.price_changes.view', 'products.price-changes.apply' => 'products.price_changes.apply', 'products.price-changes.cancel' => 'products.price_changes.cancel',
