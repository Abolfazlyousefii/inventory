...
class SalesReturnDocument extends Model
{
    ...
    public function items(){ return $this->hasMany(SalesReturnDocumentItem::class, 'document_id')->orderBy('sort_order')->orderBy('id'); }
    ...
    public static function returnReasonLabels(): array { return ['healthy_return'=>'برگشت سالم / بدون ایراد', 'damaged_product'=>'خرابی کالا', 'product_mismatch'=>'مغایرت کالا', 'wrong_dispatch'=>'اشتباه در ارسال', 'customer_cancellation'=>'انصراف مشتری', 'appearance_issue'=>'ایراد ظاهری', 'technical_issue'=>'ایراد فنی', 'registration_error'=>'ثبت اشتباه', 'other'=>'سایر']; }
}
